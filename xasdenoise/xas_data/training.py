...
def create_training_tensors(spectrum_list_train, spectrum_list_target,
                           ...
                           simulate_training_data=False, num_times=None, noise2clean=False,
    ...
    if noise2clean is False and noise2noise is False:
        raise ValueError("At least one of noise2clean or noise2noise must be True.")
...
def _warp_data(x0, y_train0, y_target0, edges0, data_mask0, glitch_mask0):
    ...
    from xasdenoise.denoising_pipeline.stationarity_warping import DataWarper
