...
def center_edges(spectrum_list):
    """
    Center the edges of the spectra in the list.

    Args:
        spectrum_list (list): List of Spectrum objects.
    """
    for data in spectrum_list:
        preproc.center_edge(data)
