...
def center_edge(data):
    """
    Center the edge of the spectrum on the middle of the absorption edge.
...
def crop_spectrum(data, pre_edge=50, post_edge=50):
    ...
    pre_edge_idx = np.where(x < edge - np.abs(pre_edge))[0]
